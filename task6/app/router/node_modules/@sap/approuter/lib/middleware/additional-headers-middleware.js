...
const stdTTL = getValidatedEnvInt('FRAME_ANCESTORS_CSP_HEADER_CACHE_TIME', 300);
const checkPeriod           = stdTTL + 20;
const NodeCache           = require('node-cache');
const {IDENTITY} = require('../utils/vcap-utils');
