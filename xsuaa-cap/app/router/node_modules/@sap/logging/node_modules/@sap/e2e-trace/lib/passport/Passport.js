...
function Passport(encoded) {
  ...
  this._content = bufferUtil.create(encoded, 'hex');
}
...
function removeVariableParts(buffer) {
  ...
  var buff2 = bufferUtil.create(varPartsMetadataLen).fill(0);

  var buff3 = bufferUtil.create(constants.EYE_CATCHER, 'hex');
