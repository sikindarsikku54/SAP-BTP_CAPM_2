...
function StatementExec(stmt, p1, p2, p3, execType) {
    ...
    if(args.cbfunc) {
        ...
        if (func === stmt.execInternal && args.options !== undefined && args.options !== null && isPropertyTrue(args.options, 'returnMultipleResultSets')) {
            // returnMultipleResultSets is true, so use the stream extension
            deleteProperty(args.options, 'returnMultipleResultSets');
            const streamExt = require('../extension/Stream.js');
            streamExt.executeMultipleResultSets2(stmt, args.params, args.options, args.cbfunc);
            return;
        }
