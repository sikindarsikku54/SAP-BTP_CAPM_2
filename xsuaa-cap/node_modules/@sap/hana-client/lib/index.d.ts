declare module '@sap/hana-client' {
    ...
    type HanaMultipleResultSetsCallback = (error: Error, ...args: any[]) => void;
    ...
    interface HanaExecCachedBufferInfo {
        settings: {[key: string]: any},
        statistics: {[key: string]: any}
    }

    function clearExecCachedBuffers(): void;
    ...
    function getExecCachedBufferInfo(): HanaExecCachedBufferInfo;
    function getThreadCount(): number;
    function setConnectionPoolLimit(limit: number): void;
    function setDeadlockPreventionEnabled(enabled: boolean): void;
    function setDynamicThreadLimit(limit: number): void;
    function setDynamicThreadsEnabled(enabled: boolean): void;
    function setExecCachedBuffers(maxBuffers: number, initialBufferKB?: number, maxCachedBufferKB?: number): void;
    ...
    class Statement {
        ...
        public exec<T>(options: {[key: string]: any}, fn: HanaMultipleResultSetsCallback): void;
        public exec<T>(params: HanaParameterList, options: {[key: string]: any}, fn: HanaResultCallback<T>): void;
        public exec<T>(params: HanaParameterList, options: {[key: string]: any}, fn: HanaMultipleResultSetsCallback): void;
        ...
        public execute<T>(options: {[key: string]: any}, fn: HanaMultipleResultSetsCallback): void;
        public execute<T>(params: HanaParameterList, options: {[key: string]: any}, fn: HanaResultCallback<T>): void;
        public execute<T>(params: HanaParameterList, options: {[key: string]: any}, fn: HanaMultipleResultSetsCallback): void;
    ...
    class Connection {
        ...
        public execute(sql: string, options: {[key: string]: any}, fn: HanaMultipleResultSetsCallback): void;
        public execute(sql: string, params: HanaParameterType[] | { [key: string]: HanaParameterType }, options: { [key: string]: any }, fn: HanaMultipleResultSetsCallback): void;
        ...
        public isValid(fn?: HanaResultCallback<boolean>): void;
        public isValid(timeout: number, fn?: HanaResultCallback<boolean>): void;
    }
    ...
    class ConnectionPool {
        ...
        public getConnection(fn: HanaResultCallback<Connection>, onWaitFn: HanaEmptyCallback): void;
        public getConnection(uid: string, pwd: string): Connection;
        public getConnection(uid: string, pwd: string, fn: HanaResultCallback<Connection>): void;
        public getConnection(uid: string, pwd: string, fn: HanaResultCallback<Connection>, onWaitFn: HanaEmptyCallback): void;
